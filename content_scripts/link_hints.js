...
(function() {
  var COPY_LINK_URL, COPY_LINK_TEXT, LinkHints, OPEN_INCOGNITO, OPEN_IN_CURRENT_TAB, OPEN_IN_NEW_TAB, OPEN_WITH_QUEUE, alphabetHints, filterHints, numberToHintString, root, spanWrap;
  ...
  LinkHints = {
    ...
    onKeyDownInMode: function(hintMarkers, event) {
      ...
      if (event.keyCode === keyCodes.shiftKey && this.mode !== COPY_LINK_URL && this.mode != COPY_LINK_TEXT) {
        prev_mode = this.mode;
