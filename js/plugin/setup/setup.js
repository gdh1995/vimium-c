	...
	var setup = (function () {
		...
		setup.prototype = {
			...
			changeDialBoxWidth : function (v, t) {
				...
				clearTimeout(_dialBoxWidthFun);
				_dialBoxWidthFun = setTimeout(function () {
			...
			changeDialBoxHeight : function (v, t) {
				...
				clearTimeout(_dialBoxHeightFun);
				_dialBoxHeightFun = setTimeout(function () {
			...
			changeDialboxRadius : function (v, t) {
				...
				clearTimeout(_dialBoxRadiusFun);
				_dialBoxRadiusFun = setTimeout(function () {
			...
			changeDialBoxSpacing : function (v, t) {
				...
				clearTimeout(_dialBoxSpacingFun);
				_dialBoxSpacingFun = setTimeout(function () {
			...
			changeDialBoxOpacity : function (v, t) {
				...
				clearTimeout(_dialBoxOpacityFun);
				_dialBoxOpacityFun = setTimeout(function () {
			...
			changeDialBoxQBCWidth : function (v, t) {
				...
				clearTimeout(_dialBoxQBCWidthFun);
				_dialBoxQBCWidthFun = setTimeout(function () {
			...
			template : function () {
				...
				var suggestHtml = '<div class="suggest"><a href="http://www.' + officialDomain + '/feedback.html" target="_blank">' + getI18nMsg('suggest') + '</a></div><div class="useHelp"><a href="http://www.' + officialDomain + '/help.html" target="_blank">' + getI18nMsg('useHelp') + '</a></div><div class="version"><a>( V' + ver.replace(".360", "") + ' )</a></div>';
