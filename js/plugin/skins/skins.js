(function ($) {
	...
	var skins = (function () {
		...
		skins.prototype = {
			...
			template : function () {
				return '<div class="skinsContainer"><div class="skinsHeader dragArea"><div class="headerIcon"></div>' +
				getI18nMsg('skinsAppTitle') + '</div><div class="skinsBody"><div class="wallpaperCategorysContainer"><div class="cloudWallpaperCategorys"></div><div class="moreSettings">' +
