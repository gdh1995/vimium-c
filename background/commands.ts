...
availableCommands: {
  ...
  copyCurrentUrl: [ "Copy page's info (use type=url/frame, decode)", 1, true, null, "copyTabInfo" ],
  autoCopy: [ "Copy selected text or current frame's title or URL (use url, decode)", 1, false ],
