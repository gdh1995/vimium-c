...
availableCommands: {
  ...
  scrollUp: [ "Scroll up", 0, false, { dir: -1 }, "scBy" ],
  scrollLeft: [ "Scroll left", 0, false, { dir: -1, axis: "x" }, "scBy" ],
  scrollRight: [ "Scroll right", 0, false, { axis: "x" }, "scBy" ],
  scrollPxDown: [ "Scroll 1px down", 0, false, { view: 1 }, "scBy" ],
  scrollPxUp: [ "Scroll 1px up", 0, false, { dir: -1, view: 1 }, "scBy" ],
  scrollPxLeft: [ "Scroll 1px left", 0, false, { dir: -1, axis: "x", view: 1 }, "scBy" ],
  ...
  scrollToBottom: [ "Scroll to the bottom of the page", 1, false, { dest: "max" }, "scTo" ],
  scrollToLeft: [ "Scroll all the way to the left", 1, false, { axis: "x" }, "scTo" ],
  scrollToRight: [ "Scroll all the way to the right", 1, false, { axis: "x", dest: "max" }, "scTo" ],
  ...
  "LinkHints.activate": [ "Open a link in the current tab (use characters=&lt;string&gt;)", 0, false, { mode: HintMode.OPEN_IN_CURRENT_TAB }, "Hints.activate" ],
  ...
  enterFindMode: [ "Enter find mode (use last=true)", 1, true, {active: true, last: true}, "performFind" ],
