...
availableCommands_: {
  ...
  scrollPageDown: [ "Scroll a page down", 0, false, kFgCmd.scroll, { dir: 0.5, view: "view" } ],
  scrollPageUp: [ "Scroll a page up", 0, false, kFgCmd.scroll, { dir: -0.5, view: "view" } ],
  scrollFullPageDown: [ "Scroll a full page down", 0, false, kFgCmd.scroll, { view: "view" } ],
  scrollFullPageUp: [ "Scroll a full page up", 0, false, kFgCmd.scroll, { count: -1, view: "view" } ],
