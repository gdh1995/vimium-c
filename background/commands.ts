...
availableCommands_: {
  ...
  openCopiedUrlInCurrentTab: [ "Open the clipboard's URL in the current tab", 1, true, kBgCmd.openUrl, { reuse: ReuseType.current, copied: true } ],
  ...
  focusInput: [ 'Focus the N-th visible text box on the page and cycle using tab (use keep, select=""/all/all-input/start/end)', 0, false, kFgCmd.focusInput /* , "." */ ],
  ...
  "LinkHints.unhoverLast": [ "Stop hovering at last location", 1, false, kFgCmd.unhoverLast /* , ".unhoverLast" */ ],
  ...
  enableCSTemp: [ "enable the site's CS in incognito window (use type=images)", 0, true, kBgCmd.toggleCS, { type: "images", incognito: true } ],
  ...
  "Marks.activateCreateMode": [ "Create a new mark (use swap)", 1, false, kFgCmd.marks, { mode: "create" } /* , ".marks" */ ],
  "Marks.activate": [ "Go to a mark (use prefix=true, swap)", 1, false, kFgCmd.marks /* , ".marks" */ ],
  ...
  focusOrLaunch: [ 'focus a tab with given URL or open it (use url="", prefix)', 1, true, kBgCmd.openUrl, { reuse: ReuseType.reuse } ]
