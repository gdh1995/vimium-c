...
availableCommands: {
  ...
  reload: [ "Reload current frame (use hard)", 1, false ],
  ...
  enterVisualMode: [ "Enter visual mode", 1, true],
  enterVisualLineMode: [ "Enter visual line mode", 1, true, { mode: "line" }, "enterVisualMode" ],
  ...
  "Vomnibar.activateBookmarksInNewTab": [ "Open a bookmark in a new tab", 1, true,
    { mode: "bookm", newtab: true }, "showVomnibar" ],
  ...
  "Vomnibar.activateHistoryInNewTab": [ "Open a history in a new tab", 1, true,
    { mode: "history", newtab: true }, "showVomnibar" ],
  ...
  "Vomnibar.activateUrlInNewTab": [ "Edit the current URL and open in a new tab", 0, true,
    { url: true, newtab: true }, "showVomnibar" ],
  ...
  "Marks.activateCreateMode": [ "Create a new mark (use swap)", 1, false, { mode: "create" }, ".marks" ],
  "Marks.activate": [ "Go to a mark (use prefix=true, swap)", 1, false, null, ".marks" ],
