...
availableCommands_: {
  ...
  "LinkHints.activate": ["Open a link in the current tab (use characters=&lt;string&gt;)", 0, 0, kFgCmd.linkHints],
  "LinkHints.activateMode": [ "Open a link in the current tab (use characters=&lt;string&gt;)", 0, 0,
    kFgCmd.linkHints ],
  ...
  findFromVisual: [ "", 0, 1, kBgCmd.performFind, { active: true, returnToViewport: true } ],
  ...
  "Marks.activateCreateMode": [ "Create a new mark (use swap)", 1, 0, kFgCmd.marks, { mode: "create" } ],
  "Marks.activate": [ "Go to a mark (use prefix=true, swap)", 1, 0, kFgCmd.marks ],
