...
availableCommands_: { __proto__: null as never,
  ...
  closeOtherTabs: [ 0, 1, 1, kBgCmd.removeTabsR ],
  closeTabsOnLeft: [ 0, 0, 1, kBgCmd.removeTabsR, { dir: -1 } ],
  closeTabsOnRight: [ 0, 0, 1, kBgCmd.removeTabsR, { dir: 1 } ],
  ...
  moveTabLeft: [ 0, 0, 1, kBgCmd.moveTab ],
  moveTabRight: [ 0, 0, 1, kBgCmd.moveTab, { dir: 1 } ],
