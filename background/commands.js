...
availableCommands: {
  ...
  scrollPxDown: [ "Scroll 1px down", 0, false, { step: 1 }, "scrollBy" ],
  scrollPxUp: [ "Scroll 1px up", 0, false, { dir: -1, step: 1 }, "scrollBy" ],
  scrollPxLeft: [ "Scroll 1px left", 0, false, { dir: -1, axis: "x", step: 1 }, "scrollBy" ],
  scrollPxRight: [ "Scroll 1px right", 0, false, { axis: "x", step: 1 }, "scrollBy" ],
  ...
  scrollPageDown: [ "Scroll a page down", 0, false, { dir: 0.5 , step: "viewSize" }, "scrollBy" ],
  scrollPageUp: [ "Scroll a page up", 0, false, { dir: -0.5 , step: "viewSize" }, "scrollBy" ],
  scrollFullPageDown: [ "Scroll a full page down", 0, false, { step: "viewSize" }, "scrollBy" ],
  scrollFullPageUp: [ "Scroll a full page up", 0, false, { dir: -1 , step: "viewSize" }, "scrollBy" ],
