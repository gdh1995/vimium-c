var setup = {
	...
	init : function (force) {
		...
		self.content.find(".dataAction").bind("click", function () {
			if ($(this).hasClass('import')) {
				...
				hiddenA[0].href = URL.createObjectURL(new Blob([data], {type: "application/json", "endings": "native"}));
	...
	template : function () {
		...
		return '<div class="settingContainer"><div class="settingBox"><div class="titleBar dragArea"><div class="titleBarIcon"></div>'
			...
			+ '</span></div><div class="dialBoxSettingsContainer"><div class="dialBoxStyle square">'
			+ dialBoxStyleContents['square'] + '</div><div class="dialBoxStyle circular">'
			+ dialBoxStyleContents['square'] + '</div><div class="dialBoxStyle seamless">'
			+ dialBoxStyleContents['seamless'] + '</div><div class="dialBoxStyle default">'
			+ dialBoxStyleContents['default'] + '</div><div class="more" title="'
			+ getI18nMsg('dialBoxSettingsMore')
			+ '"></div></div><div class="baseSettingsContainer"><div class="settingsItem"><span>'
			+ getI18nMsg('targetSwitch')
			+ '</span><div class="settingsItemSwitch"><input type="checkbox" id="targetSwitch" private="true"/><label for="targetSwitch"></label></div></div><div class="settingsItem"><span>'
			+ getI18nMsg('dialBoxPageSwitcher')
			+ '</span><div class="settingsItemSwitch"><input type="checkbox" id="dialBoxPageSwitcher" private="true"/><label for="dialBoxPageSwitcher"></label></div></div><div class="settingsItem" style="display:'
			+ (cId != "" ? "none" : "block") + '"><span>' + getI18nMsg('settingSecovery')
			+ '</span><button class="recovery">' + getI18nMsg('default')
			+ '</button></div></div><div class="oathSettingsBar"><span>' + getI18nMsg('login')
			...
			+ getI18nMsg('dialBoxPage3DSwitcher')
			+ '</span><div class="dialBoxPage3D"><input type="checkbox" id="dialBoxPage3DSwitcher" private="true"/><label for="dialBoxPage3DSwitcher"></label></div></div><div class="dialBoxTitleBar"><span>'
			+ getI18nMsg('dialBoxTitleSwitch')
			+ '</span><div class="dialBoxTitle"><input type="checkbox" id="dialBoxTitleSwitch" private="true"/><label for="dialBoxTitleSwitch"></label></div></div><div class="dialBoxQuickBar"><span>'
			+ getI18nMsg('dialBoxQuickSwitcher')
			+ '</span><div class="dialBoxQuick"><input type="checkbox" id="dialBoxQuickSwitcher" private="true"/><label for="dialBoxQuickSwitcher"></label></div></div><div class="dialBoxCloudBoxBar"><span>'
			+ getI18nMsg('dialBoxCloudBoxSwitch')
			+ '</span><div class="dialBoxCloudBox"><input type="checkbox" id="dialBoxCloudBoxSwitch" private="true"/><label for="dialBoxCloudBoxSwitch"></label></div></div></div><div class="containerBorder"><div class="dialBoxNumBar"><span>'
			+ getI18nMsg('dialBoxNum')
			+ '</span><div class="dialBoxNum"><input type="range" rtype="range" min="4" max="32" step="1" id="dialBoxNum" autocomplete="off"><div title="'
			+ getI18nMsg('dialBoxSettingsEditTitle') + '"><input type="text" class="RValue" /></div><div class="unit">'
			+ getI18nMsg('dialBoxNumUnit') + '</div></div></div><div class="dialBoxWidthBar"><span>'
			+ getI18nMsg('dialBoxWidth')
			+ '</span><div class="dialBoxWidth"><input type="range" rtype="range" min="1" max="800" step="1" id="dialBoxWidth" autocomplete="off"><div title="'
			+ getI18nMsg('dialBoxSettingsEditTitle')
			+ '"><input type="text" class="RValue" /></div><div class="unit">' + getI18nMsg('dialBoxWidthUnit')
			+ '</div></div></div><div class="dialBoxHeightBar"><span>' + getI18nMsg('dialBoxHeight')
			+ '</span><div class="dialBoxHeight"><input type="range" rtype="range" min="1" max="800" step="1" id="dialBoxHeight" autocomplete="off"><div title="'
			+ getI18nMsg('dialBoxSettingsEditTitle')
			+ '"><input type="text" class="RValue" /></div><div class="unit">' + getI18nMsg('dialBoxHeightUnit')
			+ '</div></div></div><div class="dialBoxRadiusBar"><span>' + getI18nMsg('dialBoxRadius')
			+ '</span><div class="dialBoxRadius"><input type="range" rtype="range" min="0" max="400" step="1" id="dialBoxRadius" autocomplete="off"><div title="'
			+ getI18nMsg('dialBoxSettingsEditTitle') + '"><input type="text" class="RValue" /></div><div class="unit">'
			+ getI18nMsg('dialBoxRadiusUnit') + '</div></div></div><div class="dialBoxSpacingBar"><span>'
			+ getI18nMsg('dialBoxSpacing')
			+ '</span><div class="dialBoxSpacing"><input type="range" rtype="range" min="0" max="100" step="1" id="dialBoxSpacing" autocomplete="off"><div title="'
			+ getI18nMsg('dialBoxSettingsEditTitle') + '"><input type="text" class="RValue" /></div><div class="unit">'
			+ getI18nMsg('dialBoxSpacingUnit') + '</div></div></div><div class="dialBoxOpacityBar"><span>'
			+ getI18nMsg('dialBoxOpacity')
			+ '</span><div class="dialBoxOpacity"><input type="range" rtype="range" min="0" max="1" step="0.1" id="dialBoxOpacity" autocomplete="off"><div title="'
			+ getI18nMsg('dialBoxSettingsEditTitle')
			+ '"><input type="text" class="RValue" /></div><div class="unit">' + getI18nMsg('dialBoxOpacityUnit')
			+ '</div></div></div><div class="dialBoxQBCWidthBar"><span>' + getI18nMsg('dialBoxQBCWidth')
			+ '</span><div class="dialBoxQBCWidth"><input type="range" rtype="range" min="800" max="' + screenWidth
			+ '" step="1" id="dialBoxQBCWidth" autocomplete="off"><div title="' + getI18nMsg('dialBoxSettingsEditTitle')
			+ '"><input type="text" class="RValue" /></div><div class="unit">' + getI18nMsg('dialBoxQBCWidthUnit')
