...
(function (global, factory) {
  ...
  var handlers = {
    ...
    load: function load() {
      ...
      image.style.cssText = 'height:0;' + ("margin-left:" + viewerData.width / 2 + "px;") + ("margin-top:" + viewerData.height / 2 + "px;") + 'max-width:none!important;' + 'position:relative;' + 'width:0;';
  ...
  var methods = {
     ...
     */view: function view() {
      ...
      var onViewed = function onViewed() {
        ...
        title.textContent = isFunction(render) ? render.call(_this2, image, imageData) : alt + " (" + imageData.naturalWidth + " \xD7 " + imageData.naturalHeight + ")";
      };
      var onLoad;
      var onError;
