...
export let VOther: BrowserType = !(Build.BTypes & ~BrowserType.Chrome) || !(Build.BTypes & ~BrowserType.Firefox)
    ...
    : BrowserType.Chrome
export const setOnOther = (realBrowser: BrowserType): void => { VOther = realBrowser }
...
export const setChromeVer = (realVer: BrowserVer): void => { browserVer = realVer }
...
export const setVEnabled = (newEnabled: boolean): void => { isEnabled_ = newEnabled }

export let isLocked_ = false
export const setStatusLocked = (newLocked: boolean): void => { isLocked_ = newLocked }
...
export { esc }
export const setEsc = (newEsc: EscF): void => { esc = newEsc }
