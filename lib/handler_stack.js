...
(typeof exports !== "undefined" && exports !== null ? exports : window).HandlerStack = function HandlerStack(events) {
...
(typeof exports !== "undefined" && exports !== null ? exports : window).HandlerStack.prototype = {  
  defaultEvents: ["keydown", "keypress", "keyup", "DOMActivate"],
  genId: function() {
    return ++this._counter;
  },
  push: function(handler) {
    var stacks = this.stacks, events = this.events, _i = events.length, line, key, func, stack;
    line = new Array(_i + 1);
    line[_i] = this.genId();
    while (0 <= --_i) {
      key = events[_i];
      func = handler[key];
      if (!func || (stack = stacks[key]).indexOf() >= 0) {
        line[_i] = null;
        continue;
      }
      stack.push(func);
