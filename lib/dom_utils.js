...
(typeof exports !== "undefined" && exports !== null ? exports : window).DomUtils = {
  ...
  _selectableTypes: ["search", "text", "password"],
  isSelectable: function(element) {
    return (element.nodeName.toLowerCase() === "input" && this._selectableTypes.indexOf(element.type) >= 0) || element.nodeName.toLowerCase() === "textarea";
  },
  ...
  simulateClick: function(element, modifiers) {
    var event, eventSequence = this._eventSequence, mouseEvent, _i, _len;
    modifiers || (modifiers = {});
  ...
  flashRect: function(rect) {
    ...
    flashEl.className = "vimium0 vimium1";
