    ...
    if (y0 < y1) {
      if (y2 < y3) {
        if (x0 < x1) {
          ...
          if (x2 < x3) {
            a.push([x2, y0, x3, y1], [x2, y1, x3, y2], [x0, y2, x1, y3], [x1, y2, x2, y3], [x2, y2, x3, y3]); // 4 5 6 7 8
          } else {
            a.push([x0, y2, x1, y3], [x1, y2, x2, y3]); // 6 7
          }
        } else if (x2 < x3) {
        ...
        x2 < x3 && a.push([x2, y0, x3, y1], [x2, y1, x3, y2]); // 4 5
      }
    } else if (y2 < y3) {
      if (x0 < x1) {
        if (x2 < x3) {
