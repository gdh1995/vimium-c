...
(function() {
  ...
  root.DomUtils = DomUtils = {
    ...
    makeXPath: function(elementArray) {
      for (var xpath = [], _i = 0, _len = elementArray.length; _i < _len; _i++) {
        xpath.push("//" + elementArray[_i], "//xhtml:" + elementArray[_i]);
      }
      return xpath.join(" | ");
    },
      ...
      for (_i = 0, _len = clientRects.length; _i < _len; _i++) {
        ...
        if (clientRect.width === 0 || clientRect.height === 0) {
          ...
          for (_k = 0, _len2 = _ref.length; _k < _len2; _k++) {
            ...
            childClientRect = DomUtils.getVisibleClientRect(child);
    ...
    simulateClick: function(element, modifiers) {
      var event, eventSequence, mouseEvent, _i, _len;
      modifiers || (modifiers = {});
    ...
    flashRect: function(rect) {
      ...
      return setTimeout(function() {
        DomUtils.removeElement(flashEl);
      }, 400);
    },
