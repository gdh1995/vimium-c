...
interface ObjectConstructor {
    ...
    */
    ...
    /**
      ...
      */
    keys(o: Map<string | number, any> | WeakMap<object, any> | Set<any> | WeakSet<any>): -1;
    keys(o: any): string[];
}
...
interface CallableFunction extends Function {
    ...
    apply<A extends any[], R>(this: (this: void, ...args: A) => R, thisArg: null, args: A): R;
    apply<T, A extends any[], R>(this: (this: T, ...args: A) => R, thisArg: T, args: A): R;
    apply<R>(this: (this: void, ...args: any[]) => R, thisArg: null, args: IArguments): R;
    apply<T, R>(this: (this: T, ...args: any[]) => R, thisArg: T, args: IArguments): R;
    ...
    bind<T, A0, A1, A2, A3, A extends any[], R>(this: (this: T, arg0: A0, arg1: A1, arg2: A2, arg3: A3, ...args: A) => R, thisArg: T extends void ? null | 0 : T, arg0: A0, arg1: A1, arg2: A2, arg3: A3): (...args: A) => R;
    bind<T, A0, A1, A2, A3, A4, A extends any[], R>(this: (this: T, arg0: A0, arg1: A1, arg2: A2, arg3: A3, arg4: A4, ...args: A) => R, thisArg: T extends void ? null | 0 : T, arg0: A0, arg1: A1, arg2: A2, arg3: A3, arg4: A4): (...args: A) => R;
}
...
interface String {
    ...
    /**
      ...
      */
    charCodeAt(index: number): kCharCode;
...
interface StringConstructor {
    ...
    fromCharCode(...codes: kCharCode[]): string;
}
...
interface JSON {
    ...
    /**
      ...
      * @param space Adds indentation, white space, and line break characters to the return-value JSON text to make it easier to read.
      */
    stringify<T extends BOOL = 0>(value: object, replacer: string[]): T extends 1 ? string : unknown
}
...
interface Array<T> {
    ...
    filter<S extends T>(callbackfn: (this: undefined, value: T, index: number, array: T[]) => value is S, thisArg: undefined): S[];
...
declare type PromiseConstructorLike = new <T>(executor: (resolve: (value: T) => void, reject: (reason?: any) => void) => void) => PromiseLike<T>
...
interface PromiseLike<T> {
     ...
     */
    then<TResult1 = T, TResult2 = never>(onfulfilled?: ((value: T) => TResult1 | PromiseLike<TResult1>) | undefined, onrejected?: ((reason: any) => TResult2 | PromiseLike<TResult2>) | undefined): PromiseLike<TResult1 | TResult2>;
}
...
interface Promise<T> {
     ...
     * @returns A Promise for the completion of which ever callback is executed.
     */
    then<TResult1 = T, TResult2 = never>(onfulfilled?: ((value: T) => TResult1 | PromiseLike<TResult1>) | undefined, onrejected?: ((reason: any) => TResult2 | PromiseLike<TResult2>) | undefined): Promise<TResult1 | TResult2>;
     ...
     */
    catch<TResult = never>(onrejected?: ((reason: any) => TResult | PromiseLike<TResult>) | undefined): Promise<T | TResult>;
}
