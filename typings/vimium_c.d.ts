...
declare const enum HintMode {
  ...
  OPEN_IMAGE = 36, max_media = /* OPEN_IMAGE */ 36,
  SEARCH_TEXT = 37,
  COPY_TEXT = /* (SEARCH_TEXT & ~1) + 2 */ 38,
    min_copying = /* COPY_TEXT */ 38, mode1_text_list = /* COPY_TEXT | list */ 39,
  COPY_URL = 40,
    mode1_url_list = /* COPY_URL | list */ 41, min_link_job = /* COPY_URL */ 40, max_copying = /* mode1_url_list */ 41,
  DOWNLOAD_LINK= 42,
  OPEN_INCOGNITO_LINK = 43,
